...
import { handleAdminListing } from "../../../src/lib/admin/portal-handler";
...
export async function onRequest(context: { request: Request; env: Env }): Promise<Response> {
  ...
  return handleAdminListing(context.request, context.env, createAdminStore(context.env.DB), createPortalStore(sql));
}
